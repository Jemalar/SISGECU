const offcanvasEditRepartidor = new bootstrap.Offcanvas(document.getElementById('offcanvasEditAlimento'));

let infoForm = {};
let tabla = document.getElementById("tablalimento");

const listar_alimentos = () => {
    axios({
        method: 'GET',
        url:'http://127.0.0.1:8000/listaralimentos',
